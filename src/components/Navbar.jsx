...
export default function Navbar({ onOpenCart, onOpenAuth, onOpenOrders }) {
  ...
  const { totalItemsCount = 0, cartBounce = false } = useCart() || {};
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          {/* ACCESO EXCLUSIVO ADMIN AL PANEL CONTABLE */}
          {isAdmin && (
            <Link
              to="/admin"
              style={{
          ...
          {/* MIS PEDIDOS: NUNCA SE MUESTRA SI ES ADMIN */}
          {!isAdmin && currentUser && (
            <button
              type="button"
          ...
          {/* CARRITO: NUNCA SE MUESTRA SI ES ADMIN */}
          {!isAdmin && (
            <button
              type="button"
              onClick={onOpenCart}
